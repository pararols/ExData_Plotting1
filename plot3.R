...
dades$Sub_metering_1<-as.numeric(paste(dades$Sub_metering_1))
dades$Sub_metering_2<-as.numeric(paste(dades$Sub_metering_2))
dades$Sub_metering_3<-as.numeric(paste(dades$Sub_metering_3))
